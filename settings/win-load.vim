...
if empty(glob('$HOME/AppData/Local/nvim/_machine_specific.vim'))
    ...
    silent! exec "!copy $HOME/AppData/Local/nvim/default_configs/_machine_specific_default.vim $HOME/AppData/Local/nvim/_machine_specific.vim"
    silent! exec "!copy $HOME/AppData/Local/nvim/default_configs/coc-settings.json_win $HOME/AppData/Local/nvim/coc-settings.json"
endif
...
if empty(glob('$HOME/AppData/Local/nvim/tmp/sessions'))
    silent !mkdir $HOME/AppData/Local/nvim/tmp/sessions
endif
...
if empty(glob('$HOME\AppData\Local\nvim\autoload\plug.vim'))
    silent! exec "md $HOME\AppData\Local\nvim\autoload"
...
if empty(glob('$HOME\AppData\Local\nvim\_machine_specific.vim'))
    let has_machine_specific_file = 0
    silent! exec "!cp $HOME\AppData\Local\nvim\default_configs\_machine_specific_default.vim $HOME\AppData\Local\nvim\_machine_specific.vim"
endif
